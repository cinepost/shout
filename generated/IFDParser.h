...
public:
  enum {
    ...
    T__14 = 15, T__15 = 16, COMMENT = 17, STREAM = 18, TYPE = 19, OBJECT = 20, 
    VERSION = 21, VAR_NAME = 22, VALUE = 23, INTEGER = 24, NUMBER = 25, 
    STRING = 26, NO_QUOTED = 27, QUOTED = 28, CHARS = 29, WS = 30
  };

  enum {
    RuleFile = 0, RuleLine = 1, RuleSetenv = 2, RuleVersion = 3, RuleDeclare = 4, 
    RuleStart = 5, RuleEnd = 6, RuleDetail = 7, RuleProperty = 8, RuleImage = 9, 
    RuleGeomerty = 10, RuleTime = 11, RuleRaytrace = 12, RuleQuit = 13
  };
